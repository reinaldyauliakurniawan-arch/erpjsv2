...
{{-- SIDEBAR DESKTOP --}}
<aside class="fixed left-0 top-0 h-screen w-[240px] hidden lg:flex flex-col z-30" style="background:#111827;border-right:1px solid rgba(255,255,255,.08)">

    <div class="px-lg pt-xl pb-lg" style="border-bottom:1px solid rgba(255,255,255,.08)">
        <h1 class="text-headline-lg font-bold" style="color:#ffffff">Just Speak</h1>
        <p class="text-body-md mt-xs" style="color:#9CA3AF">
    ...
    <div class="px-sm pb-lg pt-md space-y-xs" style="border-top:1px solid rgba(255,255,255,.08)">
        <a href="{{ route('profile.edit') }}"
           class="flex items-center gap-md px-md py-sm rounded-lg text-body-md transition-all"
           style="color:#9CA3AF"
...
<header class="fixed top-0 right-0 left-0 lg:left-[240px] h-16 z-40 flex items-center px-gutter" style="background:#ffffff;border-bottom:1px solid #E5E7EB;box-shadow:0 1px 3px rgba(0,0,0,.06)">
    <div class="flex justify-between items-center w-full">
        ...
        <div class="flex items-center gap-sm">
            <div class="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm text-white" style="background:#059669">
...
<div class="drawer lg:hidden">
    ...
    <div class="drawer-side z-50">
        ...
        <aside class="w-[240px] min-h-full flex flex-col p-md" style="background:#111827">
            <div class="flex justify-between items-center mb-lg">
                <div>
                    <h1 class="text-headline-md font-bold" style="color:#ffffff">Just Speak</h1>
